...
use crate::win::{self, MouseClickType};
...
pub fn call_back(message: Message) {
    ...
    match topic.as_str() {
        "WinMobControl/PushMouseButton" => {
            ...
            // マウスボタン押下
            let mouse_click_down_input = win::get_mouse_click_down_input(button);
            // マウスボタン解放
            let mouse_click_up_input = win::get_mouse_click_up_input(button);
        ...
        "WinMobControl/ScrollMouseWheel" => {
            ...
            let wheel_input = win::get_mouse_wheel_input(payload.delta);
        ...
        "WinMobControl/MoveMouseCursor" => {
            ...
            let mouse_move_input = win::get_mouse_move_input(payload.delta_x, payload.delta_y);
